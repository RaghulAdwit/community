...
public class Constants {
	...
	public static final String SUBDOMAIN_DETAILS = "subdomain_details";
	public static final String ADVERTISER_TRACK = "advertiser_track";
	public static final String ADVERTISER_VIEW = "advertiser_VIEW";

	public static final String BUCKET = SpringProperty.getPropValue("bucketName") != null
			? SpringProperty.getPropValue("bucketName")
			: "evolve2.0";

	public static final String s3Link = SpringProperty.getPropValue("s3Link") != null
			? SpringProperty.getPropValue("s3Link")
			: "https://encredia.s3.ap-south-1.amazonaws.com";
