...
Advertiser advertiserDetails = request.getAttribute(Constants.ADVERTISER_DETAILS) != null
		? (Advertiser) request.getAttribute(Constants.ADVERTISER_DETAILS)
		: null;

ArrayList<AdvertiserGallery> advertiserGalleryList = request.getAttribute(Constants.ADVERTISER_GALLERY_LIST) != null
		? (ArrayList<AdvertiserGallery>) request.getAttribute(Constants.ADVERTISER_GALLERY_LIST)
		: null;
ArrayList<Coupon> couponList = request.getAttribute(Constants.ADVERTISER_COUPON_LIST) != null
		? (ArrayList<Coupon>) request.getAttribute(Constants.ADVERTISER_COUPON_LIST)
		: null;
ArrayList<AdvertiserService> advertiserServiceList = request.getAttribute(Constants.ADVERTISER_SERVICE_LIST) != null
		? (ArrayList<AdvertiserService>) request.getAttribute(Constants.ADVERTISER_SERVICE_LIST)
		: null;
%>
...
<meta property="og:description"
	content="<%=advertiserDetails.getAboutUs()%>">
<meta property="og:type" content="website">
<meta property="og:url"
	content="<%=advertiserDetails.getAdvertiserId()%>/" />

<meta property="og:image" itemprop="image"
	content="http://encredia.com/assets/images/logo.png">
...
<link rel="stylesheet"
	href="<%=assetsPath%>/assets/css/themify-icons.css" />
<link rel="stylesheet" href="<%=assetsPath%>/assets/css/et-line.css" />

<!-- Custom Css -->
<link rel="stylesheet" type="text/css"
	href="<%=assetsPath%>/css/main.css">
<link rel="stylesheet" type="text/css"
	href="<%=assetsPath%>/css/index_business.css">


<!-- Fonts -->
<link
	href="https://fonts.googleapis.com/css?family=Rubik:400,500%7CSignika:400,600,700"
	rel="stylesheet">
...
<body>
					...
					<ul class="list-group list-group-flush">
						<div class="card_header">
							...
							<div class="title">
								...
								<p class="category">
									<a
										href="<%=contextPath%>/category/<%=Constants.toSlug(advertiserDetails.getCategory().getName())%>/<%=EncryptionUtil.encode(advertiserDetails.getCategory().getCategoryId() + "")%>/"><%=advertiserDetails.getCategory().getName()%></a>
								</p>
							</div>
							<div class="logo">
								<%
						...
						<div class="address_section">
							<span class="padding-right-20"><a class="track_direction"
								href="https://maps.google.com?daddr=<%=advertiserDetails.getAddress()%>"
								data-bu_id="<%=EncryptionUtil.encode(advertiserDetails.getAdvertiserId() + "")%>"
								target="_blank"><i class="fas fa-map-marker-alt"
									aria-hidden="true"></i> <%=advertiserDetails.getAddress()%></a></span> <span><a
								class="cta track_phone"
								data-bu_id="<%=EncryptionUtil.encode(advertiserDetails.getAdvertiserId() + "")%>"
								href="tel:<%=advertiserDetails.getPhoneNumber()%>"> <i
									class="fa fa-phone" aria-hidden="true"></i> <%=advertiserDetails.getPhoneNumber()%></a>
							</span>
						</div>  
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div id="carouselExampleInterval"
										class="carousel slide gallery" data-bs-ride="carousel">
										...
										<div class="carousel-inner">
											...
											<div class="carousel-item active">
												<img
													...
													data-bu_id="<%=EncryptionUtil.encode(advertiserDetails.getAdvertiserId() + "")%>"
													alt="image 1" data-bs-toggle="modal"
										...
										<div class="" style="padding: 0px">
											...
											<div class="embed-responsive embed-responsive-4by3">
												<iframe width="560" height=""
													src=<%=advertiserDetails.getFeaturedVideo()%>
					...
					<div class="card-body">
						...
						<div class="container px-0 mb-3">
							<div class="row text-center icons ">
								<div class="col">
									<a class="cta center padding-right-20 track_direction"
										data-bu_id="<%=EncryptionUtil.encode(advertiserDetails.getAdvertiserId() + "")%>"
										href="https://maps.google.com?daddr=<%=advertiserDetails.getAddress()%>"
										target="_blank" rel=""> <i
										class="fa-solid fa-diamond-turn-right fa-2x icon-blue"></i>
										<p class="blue">Directions</p>
									</a>
								</div>
								<div class="col">
									<a class="cta center padding-right-20 track_website"
										data-bu_id="<%=EncryptionUtil.encode(advertiserDetails.getAdvertiserId() + "")%>"
										href="<%=advertiserDetails.getWebsite()%>" target="_blank"
										rel=""> <i class="fa fa-desktop fa-2x icon-blue"
										aria-hidden="true"></i>
										<p class="blue">Website</p>
									</a>
								</div>
								<div class="col">
									<a class="cta center padding-right-20 track_share"
										data-bu_id="<%=EncryptionUtil.encode(advertiserDetails.getAdvertiserId() + "")%>"
										href="#" target="_blank" rel=""> <i
										class="fa fa-share-alt fa-2x icon-blue" aria-hidden="true"></i>
						...
						<div class="contactUs" style="margin-bottom: 10px">
							...
							<div>
								...
								<input type="email" class="form-control"
									id="exampleFormControlInput2" placeholder="Your e-mail address" />
							</div>
							<div>
						...
						<div class="row">
							...
							if (!Constants.isStringNull(advertiserDetails.getFbLink())
									|| !Constants.isStringNull(advertiserDetails.getInstagramHandleName())) {
							%>
							<hr />
									...
									<div class="card-body socialMedia_card">
										<div class="facebook-box">
											<div style="width: 190px;">
												...
												<iframe
													src="https://www.facebook.com/plugins/page.php?href=<%=advertiserDetails.getFbLink()%>&tabs=timeline&width=400&height=300&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=false&appId"
	...
	<script
		src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCo_UiZM19FOm6-Vpl42HXNDrpYwGHCzPo"></script>
