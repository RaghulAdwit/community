...
SubDomain subDomain = request.getAttribute(Constants.SUBDOMAIN_DETAILS)!=null?(SubDomain)request.getAttribute(Constants.SUBDOMAIN_DETAILS):null;
		...
		<div class="page-content-wrapper">
			...
			<div>
				...
				<div class="top_head_txt">
					<b><p class="padding-top-10">Edit Subdomain</p></b>
			...
			<div class="page-content ">
				...
				<p class="black">
					<b> <a href="<%=contextPath %>/admin/subdomain/viewall">Manage</a></b>
				</p>
				...
				<div class="portlet box ">
					<div class="portlet-body form ">
						<form enctype="multipart/form-data" class="form-horizontal"
							role="form"
							action="<%=contextPath %>/admin/subDomain/edit/<%=CipherUtils.encryptId(subDomain.getSubDomainId()+"") %>/"
							method="post">
							<div class="form-body">

								<div class="form-group">
									<label class="col-md-2 control-label">Subdomain Name</label>
									<div class="col-md-4">
										<input type="text" class="form-control" name="name" id="name"
											value="<%=subDomain.getName()%>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" class="form-control" name="logoLink"
											id="logoLink" value="<%=subDomain.getLogoUrl()%>">
									</div>
								</div>

								<div class="form-group">
									<label class="col-md-2 control-label">Subdomain URL</label>
									<div class="col-md-4">
										<input type="text" class="form-control" name="subdomainLink"
											id="subdomainLink" value="<%=subDomain.getSubdomainURL()%>">
									</div>
								</div>

								<div class="form-group">
									<label class="col-md-2 control-label">Banner Image URL</label>
									<div class="col-md-4">
										<input type="text" class="form-control" name="bannerimgLink"
											id="bannerimgLink" value="<%=subDomain.getBannerImageURL()%>">						
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<textarea class="form-control" rows="3" name="header"
											id="header"><%=subDomain.getHeaderText()%></textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<textarea class="form-control" rows="3" name="footer"
											id="footer"><%=subDomain.getFooterText()%></textarea>
									</div>
								</div>
