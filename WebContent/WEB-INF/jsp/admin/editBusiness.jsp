	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			...
			<div class="page-content ">
				...
				<p class="black">
					<b> <a href="<%=contextPath %>/admin/business/viewall">Manage</a></b>
				</p>
				...
				<div class="portlet box ">
					<div class="portlet-body form ">
						<form enctype="multipart/form-data" class="form-horizontal"
							role="form"
							action="<%=contextPath %>/admin/business/edit/<%=CipherUtils.encryptId(advertiser.getAdvertiserId()+"") %>/"
							method="post">
							<input type="hidden" name="exImg" id="exImg"
								value="<%=advertiser.getLogo()%>">
							<div class="form-body">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										...
										<select class="form-control" name="categoryId" id="categoryId">
											...
											<option
												<%if(category.getCategoryId()==advertiser.getCategory().getCategoryId()){ %>
												selected="selected" <%} %>
								...
								<div class="form-group">
									...
									<div class="col-md-5 col-xs-6">
										<div class="input-group up_img">
											<input id="input-7" name="file" accept="image/*" type="file"
												class="file form-control"
												data-allowed-file-extensions='["jpg", "jpeg", "png", "gif", "bmp", "tiff"]' />
										</div>
									</div>
								</div>
								...
								<div class="form-group hide">
									<label class="col-md-2 control-label">Logo Image</label>
									<div class="col-md-4">
										<img class="form-control bak_img" id="blah"
											src="assets/images/whiteimg.jpg" alt="your image" />
									</div>
									<div class="col-md-2 col-xs-6">
										<div class="input-group up_img">
											<span class="input-group-btn"> <span
												class="btn btn-primary btn-file"> Upload Image <input
													type="file" onchange="readURL(this);" class="up_img_btn">
											</span>
											</span>
										</div>
									</div>
								...
								<div class="form-group hide">
									...
									<div class="col-md-2 col-xs-6">
										<div class="input-group up_img">
											<span class="input-group-btn"> <span
												class="btn btn-primary btn-file"> Upload Video <input
													type="file" onchange="readURL(this);" class="up_img_btn">
											</span>
											</span>
										</div>
							...
							<hr>
							<div class="form-body">
								<p class="table_head padding-bottom-20">
									<b>Social Media </b>
								</p>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" class="form-control" name="fbLink"
												id="fbLink" value="<%=advertiser.getFbLink()%>"> <span>Ex
												: https://facebook.com/natgeo</span>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" class="form-control" name="twitterLink"
												id="twitterLink" value="<%=advertiser.getTwitterLink()%>">
											<span>Ex : https://twitter.com/NatGeo</span>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label">Instagram Handle
											Name</label>
										<div class="col-md-4">
											<input type="text" class="form-control" name="instaLink"
												id="instaLink"
												value="<%=advertiser.getInstagramHandleName()%>"> <span>Ex
												: natgeo</span>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" class="form-control" name="youtubelink"
												id="youtubelink"
												value="<%=advertiser.getFeaturedVideo()%>"> 
											<span>Ex : https://www.youtube.com/embed/F3zw1Gvn4Mk</span>
										</div>
									</div>
							...
							<div class="form-body">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" class="form-control num_rad"
											name="phoneNumber" id="phoneNumber"
											value="<%=advertiser.getPhoneNumber()%>">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" class="form-control" name="email"
											id="email" value="<%=advertiser.getEmail()%>">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" class="form-control" name="website"
											id="website" value="<%=advertiser.getWebsite()%>"> <span>Ex
											: https://adwitglobal.com</span>
									</div>
								</div>
							</div>
							...
							<div class="form-body">
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" class="form-control num_rad" id="latitude"
											name="latitude" value="<%=advertiser.getLatitude()%>">
										<span>to get lat/long, please use <a
											href="https://www.latlong.net/convert-address-to-lat-long.html"
											target="_blank">https://www.latlong.net/convert-address-to-lat-long.html</a></span>
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label">Longitude</label>
									<div class="col-md-4">
										<input type="text" class="form-control num_rad" id="longitude"
											name="longitude" value="<%=advertiser.getLongitude()%>">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label">About Us</label>
									<div class="col-md-4">
										<textarea class="form-control" rows="3" name="aboutUs"
											id="aboutUs"><%=advertiser.getAboutUs()%></textarea>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="checkbox" name="isFeatured" id="isFeatured"
											value="1" <%if(advertiser.isFeatured()){%> checked="checked"
											<%} %>> <span class="help-inline">check it for
											Featured Ads</span>
									</div>
								</div>
							</div>
						...
						<div class="col-md-12">
							...
							<div class="portlet-body back_white">
								...
								<div class="margin-top-20">
									...
									<button type="submit" class="btn btn-primary col-md-2">Save
										Business</button>
									<a href="<%=contextPath %>/admin/business/viewall"
										class="btn btn-border-blue  col-md-2">Back</a>
								</div>
...
<![endif]-->
	...
	<script src="<%=assetsPath%>/global/plugins/jquery-ui/jquery-ui.min.js"
		type="text/javascript"></script>
	<script
