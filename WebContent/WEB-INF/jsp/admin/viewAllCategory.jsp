	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			...
			<div class="top_head_txt">
					<b><p class="padding-top-10">Manage Categories</p></b>
				</div>
			</div>
				<!-- END PAGE HEADER-->
		...
		<p class="black"><b><a href="<%=contextPath %>/admin/category/add">Add New</a> </b></p>
						...
						<div class="">
							...
							<div class="portlet-body back_white" >
								...
								<tr class="odd <%=index%2==0?"gradeX":""%>">
									...
									<td >
										<%if(!Constants.isStringNull(category.getImage())){ %><img style="width: 100px;height: auto" src="https://adwit-community.s3.ap-south-1.amazonaws.com/category/<%=category.getImage()%>" ><%} %>
									</td>
									
									<td>
<%-- 										<a href="<%=contextPath %>/admin/category/edit/<%=CipherUtils.encryptId(category.getCategoryId()+"") %>/"><span class="glyphicon glyphicon-edit"> --%>
<!-- 										</span></a> -->
									</td>
									</tr>
                                    <%} %>
