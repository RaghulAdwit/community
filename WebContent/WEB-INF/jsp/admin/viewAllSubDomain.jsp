		...
		<div class="page-content-wrapper">
			...
			<div>
				...
				<div class="top_head_txt">
					<b><p class="padding-top-10">SubDomain</p></b>
				</div>
			</div>
			<!-- END PAGE HEADER-->
						...
						<div class="" style="width:100%">
							...
							<div class="portlet-body back_white">
								...
								<table class="table table-striped table-bordered table-hover"
									id="sample_1" style="width:100%,table-layout:fixed,overflow-x: auto;">
									<thead> 	
										<tr><th>ID</th>
									...
									<tbody>
										...
										for(SubDomain subDomain : subDomainList){ %>
												...
												<td><%=index++ %></td>
											<td><%=subDomain.getName() %></td>
											<td><%=subDomain.getLogoUrl() %></td>
											<td><%=subDomain.getSubdomainURL() %></td>
											<td><%=subDomain.getBannerImageURL() %></td>
											<td><%=subDomain.getHeaderText() %></td>
											<td><%=subDomain.getFooterText() %></td>
											<td><a
												href="<%=contextPath %>/admin/subDomain/edit/<%=CipherUtils.encryptId(subDomain.getSubDomainId()+"") %>/"><span
