...
String successMsg = (String) request.getAttribute(Constants.ADMIN_SUCCESS_MESSAGE);
String errorMsg = (String) request.getAttribute(Constants.ADMIN_ERROR_MESSAGE);
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">	<% if ((successMsg) !=null) { %>
		<%=successMsg%>
		<% } else { %>
		<%=errorMsg%>
		<% } %></h5>
		...
		<div class="page-content-wrapper">
			...
			<div>
				...
				<div class="top_head_txt">
					<b><p class="padding-top-10">Add New Subdomain</p></b>
				</div>
			</div>
			<!-- END PAGE HEADER-->
				...
				<div class="portlet box ">
					<div class="portlet-body form ">
						<form enctype="multipart/form-data" class="form-horizontal"
							role="form" action="<%=contextPath %>/admin/subdomain/add"
							method="post">
							<div class="form-body">
									...
									<div class="portlet-body back_white">
										<div class="margin-top-20">
											...
											<button type="submit" class="btn btn-primary col-md-2"
												data-toggle="modal" data-target="#Modalpopup">Save
												Subdomain</button>
										</div>
